...
"""This package contains the tests for rounds of LLMAnalysis."""
...
class BaseLLMAnalysisRoundTest(BaseRoundTestClass):
    """Base test class for LLMAnalysis rounds."""
...
class TestExecuteLLMRound(BaseLLMAnalysisRoundTest):
    """Tests for ExecuteLLMRound."""

    round_class = ExecuteLLMRound
